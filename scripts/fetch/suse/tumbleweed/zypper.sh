...
FILE="opensuse-tumbleweed-image.x86_64-lxc.tar.xz"
export IS_DNF=0

if echo ${LANG} | grep -q "^zh_CN"; then
    . ${DIR}/i18n/scripts/fetch/suse/tumbleweed/zypper_sh/zh_CN.sh
else
    . ${DIR}/i18n/scripts/fetch/suse/tumbleweed/zypper_sh/en_US.sh
fi
