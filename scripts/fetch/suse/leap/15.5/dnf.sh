...
FILE="opensuse-leap-dnf-image.x86_64-lxc-dnf.tar.xz"
export IS_DNF=1

if echo ${LANG} | grep -q "^zh_CN"; then
    . ${DIR}/i18n/scripts/fetch/suse/leap/15.5/dnf_sh/zh_CN.sh
else
    . ${DIR}/i18n/scripts/fetch/suse/leap/15.5/dnf_sh/en_US.sh
fi
